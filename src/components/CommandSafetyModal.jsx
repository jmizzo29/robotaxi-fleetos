function classifyCommand(command = '', priority = 'NORMAL') {
  ...
  return {
    ...
    detail: 'This queues a non-destructive workflow item and records it in FleetOS memory.',
  };
}
      ...
      <section className="w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-slate-950 shadow-2xl shadow-black/50">
        <div className="border-b border-white/10 p-5">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-400">
            FleetOS will queue this command, write it to the audit trail, and keep Tesla execution boundaries explicit.
          </p>
        </div>
