    ...
    <div className="relative flex min-h-[100dvh] flex-col overflow-hidden bg-[#0E0F12] text-[#F3F3F1]">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col px-6 pb-[max(1.75rem,env(safe-area-inset-bottom))] pt-16">
        <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col items-center justify-center text-center">
          <p className={`${monumentType.label} text-white/45`}>ROBOAGENT</p>
          <h1 className="mt-5 max-w-[16ch] text-[clamp(3.4rem,14vw,8.4rem)] font-medium leading-[0.86] tracking-[-0.055em] text-white">
            Robotaxi
          </h1>
