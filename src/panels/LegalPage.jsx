...
const legalCopy = {
  ...
  terms: {
    eyebrow: 'Terms',
    title: 'FleetOS Beta Terms',
    sections: [
      ['Beta software', 'FleetOS is in beta and may be inaccurate, unavailable, incomplete, or delayed. Do not rely on it for emergency, safety, security, or autonomous-driving decisions.'],
      ['Tesla boundary', 'FleetOS is not affiliated with or endorsed by Tesla. Tesla controls vehicle access, API availability, autonomous driving eligibility, and command execution.'],
      ...
      ['Consent', 'By connecting Tesla, you authorize FleetOS to process telemetry needed to provide the beta service. You may revoke access and request deletion.'],
      ['No warranty', 'FleetOS is provided as-is during beta with no guarantee of revenue, savings, uptime, or data accuracy.'],
    ],
  },
};
