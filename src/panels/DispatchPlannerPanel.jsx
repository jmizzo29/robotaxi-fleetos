      ...
      <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-amber-400/20 bg-amber-400/10 p-4">
          ...
          <p className="mt-2 text-sm font-bold text-amber-50">
            FleetOS plans; Tesla controls autonomous execution.
          </p>
        </div>
      </div>
    </article>
        ...
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-400">
              FleetOS can recommend where each vehicle should stage, whether it should charge first, and what revenue window to expect. The app is planning operator intent; Tesla still controls any autonomous driving capability.
            </p>
          </div>
