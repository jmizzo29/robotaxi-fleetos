    ...
    <section className="mb-8 rounded-lg border border-white/10 bg-slate-900/80 p-6 shadow-lg shadow-black/10">
      <div className="mb-5 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <h2 className="text-2xl font-black tracking-tight">Intelligent Alert Center</h2>
          <p className="mt-2 max-w-3xl text-sm text-slate-400">
            {analysis?.summary || 'FleetOS AI is ranking active operating risks.'}
          </p>
        </div>
        ...
        {alerts.length === 0 && (
          <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/10 p-4 text-emerald-200">
            ...
            <p className="mt-1 text-sm text-emerald-100/80">
              FleetOS has not detected a high-priority operating risk in the current snapshot.
            </p>
          </div>
        )}
