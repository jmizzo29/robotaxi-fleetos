  ...
  return (
    <ClerkProvider
      ...
      appearance={{
        ...
        elements: {
          card: 'border border-slate-200 bg-white text-[#141b27] shadow-2xl shadow-slate-900/20',
          modalBackdrop: 'bg-slate-950/25 backdrop-blur-sm',
          headerTitle: 'text-[#141b27] font-black',
          ...
          formButtonPrimary: 'bg-[#172231] text-white hover:bg-[#243044] shadow-none font-black',
          socialButtonsBlockButton: 'border border-slate-300 bg-white text-[#141b27] hover:bg-slate-50',
          socialButtonsBlockButtonText: 'text-[#141b27] font-semibold',
