# FleetOS AI Architecture

## 1. Updated System Architecture

FleetOS should evolve into an AI-operated fleet console, not a dashboard with AI sprinkled in.
...
2. FleetOS normalizes real + simulated vehicles into one operating snapshot.
...
If no AI key is configured, FleetOS uses deterministic local heuristics so the UI remains useful.
...
The important product principle: FleetOS should learn from what operators accepted, ignored, or corrected.
